...
              <img src="profile.png" alt="Profile" className="w-[75px] h-[75px] object-cover rounded-full border-2 border-gray-300" />
              <img src="edit.png" className="absolute bottom-0 right-0 w-5 h-5 rounded-full border-2 border-white bg-gray-200 p-1" alt="Edit" />
            </div>
            <h3 className="mt-3 text-lg font-semibold text-white text-center">Kristen Waters</h3>
...
              </div>
              <div className="bg-white px-[7px] py-[7px] rounded-[16px] flex items-center gap-[20px] font-semibold shadow-sm text-gray-900">
                <img src="flame.png" alt="Fire" className="w-5 h-5" /> 4
              </div>
              <div className="bg-white px-[7px] py-[7px] rounded-[16px] flex items-center gap-[20px] font-semibold shadow-sm text-gray-900">
...
        </div>
        ...
        <section className="bg-white shadow-md p-5 rounded-2xl font-sans flex flex-col justify-between flex-1 w-[419px] h-[320px]">
          ...
          <div className="flex-grow flex flex-col justify-center p-3">
            <img src="asylum.png" alt="Featured" className="w-full h-[180px] object-cover rounded-2xl" />
         
      <p className="mt-5 text-base font-semibold text-center leading-tight">Asylum And Extradition: Meaning And Purpose</p>
...
          <div className="carousel-track flex overflow-x-auto gap-5 scroll-smooth pb-5"> 
            {[1, 2, 3].map((_, index) => (
              <div className="bg-white rounded-2xl p-4 w-[310px] shadow-md flex-shrink-0 max-h-[250px]" key={index}> 
                <img src="course.png" alt="Course" className="w-full h-[100px] rounded-xl object-cover" />
