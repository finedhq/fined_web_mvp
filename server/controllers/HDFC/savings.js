...
const scrapeHDFCSavings = require('../../scrappers/scrapeHDFC/savingshdfc.js');


const fetchAndStoreHDFCSavings = async (req, res) => {
  try {
...
module.exports = fetchAndStoreHDFCSavings;
