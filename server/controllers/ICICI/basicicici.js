...
const scrapeBasicICICISavings = require('../../scrappers/scrapeICICI/icicibasic.js');


const fetchAndStoreBasicICICISavings = async (req, res) => {
  try {
...
module.exports = fetchAndStoreBasicICICISavings;
