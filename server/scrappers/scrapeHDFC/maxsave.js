...
const scrapeHDFCMaxSavings = async () => {
...
const sections = await page.$$eval(".cs81Heading", (headings) => {
  ...
  headings.forEach((heading) => {
    ...
    if (text.includes("max savings")) result.features = items;
  });
  ...
  return {
    bank_name: "HDFC",
    product_name: "HDFC Max Savings Account",
...
module.exports = scrapeHDFCMaxSavings;
